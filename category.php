        ...
        <div class="cs-item-list">
            ...
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    // Category display
                    echo '<div class="cs-item set-bg" data-setbg="https://panelpro.osrtraders.com/pages/category/' . htmlspecialchars($row["category_image"]) . '" onclick=window.location.href="https://osrtraders.com/result?productType=' . str_replace(' ', '%20', htmlspecialchars($row["category_name"])) . '">';
