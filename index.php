            ...
            <div class="search-form-content">
                <form action="#" class="filter-form">
                    ...
                    <select class="sm-width">
                        ...
                        <option value="">Torquise</option>
                        <option value="">Purple</option>
                    </select>
                    <select class="sm-width">
                        <option value="">Brand's</option>
                        <option value="">Roca</option>
                        <option value="">Parryware</option>
                        <option value="">Somany</option>
                        <option value="">Asianpaints</option>
